    ...
    <div class="col s12 m12 l3 item product">
        <div class="card">
            <div class="card-image waves-effect waves-block waves-light">
                <a href="index.php?action=product&id=<?= $product['id'] ?>" class="btn-floating btn-large btn-price waves-effect waves-light cyan accent-4"><?= $product['price'] ?> €</a>
                <a href="index.php?action=product&id=<?= $product['id'] ?>" class="default-image">
            ...
            <div class="card-content">
                <div class="row">
                    <div class="col s12">
                        <p class="card-title grey-text text-darken-4"><a href="index.php?action=product&id=<?= $product['id'] ?>" class="grey-text text-darken-4"><?= $product['name'] ?></a></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col s6">
